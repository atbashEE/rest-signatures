...
import be.atbash.ee.security.signature.api.common.utils.PEM;
...
public abstract class AbstractTestWithRSAKey {
    ...
    @Before
    public void setupKeys() throws InvalidKeySpecException, IOException {
